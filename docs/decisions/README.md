...
| 0034 | [A PDF deliverable: a peer Reporter, not a post-processor](0034-pdf-deliverable.md) | the PDF is the HTML page printed in memory; the engine is probed at startup; `/report` answers 415 for a binary deliverable | accepted |
